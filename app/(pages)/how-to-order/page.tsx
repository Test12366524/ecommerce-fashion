...
function HowToOrderContent() {
  ...
  // ✅ PERBAIKAN: Menggunakan Generic untuk tipe data yang aman
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div>
                ...
                <h3 className="font-bold uppercase tracking-wider">Chat</h3>{" "}
                <p>+62 817 694 2128</p>
              </div>
              <div>
                <Mail className="w-8 h-8 mx-auto mb-4" />{" "}
                <h3 className="font-bold uppercase tracking-wider">Email</h3>{" "}
                <p>support@blackboxinc.id</p>
              </div>
              <div>
                <HeadphonesIcon className="w-8 h-8 mx-auto mb-4" />{" "}
                <h3 className="font-bold uppercase tracking-wider">Hours</h3>{" "}
                <p>Mon - Fri, 8AM - 5PM</p>
              </div>
            </div>
          </div>
